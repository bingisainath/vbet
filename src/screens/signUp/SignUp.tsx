...
const SignInScreen = ({navigation}) => {
  ...
  const isPasswordValid = (password: string) => {
    ...
    Pattern.test(String(data.password))
      ? setPassError('')
  ...
  const onChange = (event:string, selectedDate:string) => {
  ...
  const textNameChange = (val: string) => {
    if (val.length !== 0) {
      setData({
        ...data,
        name: val,
      ...
      if (
        ...
        if (Emailerror == '') {
          if (Passerror == '') {
            ...
            Alert.alert(
              'Alert',
              'Enter Valid Password  It must be 7 characters',
            );
          }
        } else {
      ...
      <Animatable.View animation="fadeInUpBig" style={styles.footer}>
        <ScrollView
          ...
          <View style={styles.action}>
            <FontAwesome5 name="mail-bulk" color="#05375a" size={20} />
            <TextInput
          ...
          <View style={styles.action}>
            <MaterialIcons name="place" color="#05375a" size={20} />
            <TextInput
